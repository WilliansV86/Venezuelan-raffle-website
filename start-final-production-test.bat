@echo off
echo ===============================================
echo Venezuelan Raffle Website - FINAL Production Test
echo ===============================================
echo.
...
echo.
echo Configuring MongoDB connection adapter...
copy /Y config\db.adapter.js config\db.js >nul

echo.
echo ===============================================
echo Starting server for final production testing
echo ===============================================
echo.
