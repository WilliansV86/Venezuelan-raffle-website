@echo off
echo ===============================================
echo Venezuelan Raffle Website - COMPLETE WEBSITE TEST
echo ===============================================
echo.
...
echo.
echo Replacing MongoDB connection module...
copy /Y "config\mongodb-connection.js" "config\db.js" >nul
...
echo ===============================================
echo.
echo After server starts, you can test by opening:
echo http://localhost:5001/api/health
echo.
echo For purchase testing, use:
echo file:///c:/Users/WParedes/Desktop/Venezuelan-raffle-website/fixed-purchase-form.html
echo.
