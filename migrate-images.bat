@echo off
echo ===============================================
echo Venezuelan Raffle Website - Image Migration Tool
echo ===============================================
echo This tool will migrate existing payment screenshots to Cloudinary
echo.
...
if %errorlevel% neq 0 (
  ...
  echo Your payment screenshots are now stored in Cloudinary.
  echo.
)
