# PowerShell script for safely pushing code to GitHub
Write-Host "====================================================="
Write-Host "SAFELY PUSHING VENEZUELAN RAFFLE WEBSITE TO GITHUB"
Write-Host "====================================================="
Write-Host ""
...
$tempDir = "Venezuelan-raffle-clean"
$fullTempPath = Join-Path -Path ([System.IO.Path]::GetTempPath()) -ChildPath $tempDir

Write-Host "1. Creating clean copy of project in temp directory..."
...
Write-Host "6. Creating initial commit..."
git commit -m "Clean repository with updated email template and hidden ticket numbers"

Write-Host "7. Setting up GitHub remote..."
...
Write-Host "8. Creating version10-clean branch..."
git checkout -b version10-clean

Write-Host "9. Pushing to GitHub..."
git push -u origin version10-clean --force

Write-Host ""
Write-Host "====================================================="
Write-Host "Clean repository has been pushed to GitHub."
Write-Host "This can now be safely deployed to Render and Netlify."
Write-Host "====================================================="
